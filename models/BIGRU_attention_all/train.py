...
flags.DEFINE_integer('max_max_epoch', 3, 'all training epoches, default: 6')
flags.DEFINE_float('lr', 5e-5, 'initial learning rate, default: 8e-4')
...
data_train_path = '../../data_new/wd-data_all_230_s/data_train/'
...
def valid_epoch(data_path, sess, model):
    ...
    for i in xrange(n_va_batches):
        ...
        X1_length, X2_length = get_sequence_length(X1_batch, X2_batch, y_batch)
...
def train_epoch(data_path, sess, model, train_fetches, valid_fetches, train_writer, test_writer):
    ...
    for batch in tqdm(xrange(n_tr_batches)):
        ...
        [X1_batch, X2_batch, y_batch] = get_batch(data_train_path, batch_id)#128
        #x1.shape=(128, 30), x2.shape=(128, 200),y.shape=(128,)
